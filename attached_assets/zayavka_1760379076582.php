...
/*АЛИФ ОПЛАТА*/
    ...
    // ОСНОВНЫЕ данные для Алиф, которые понадобятся на следующей странице
    $key = 152065;
    $password = 'aIttCuLj96G4QAFCKzbA';
    $callbackUrl = 'https://www.bunyodtour.tj/alif_callback.php';
    $returnUrl = 'https://www.bunyodtour.tj/return.php';
    $amount = $total_price;
    $orderId = $last_id;
    $gate = 'vsa';
    $info = "Оплата тура №".$last_id;
    $email = $tourist_mail;
    $phone = $tourist_phone;
