...
window.translations = window.translations || {
    ...
    'nav.b2b_partnership': { ru: 'Турагентам', en: 'For Tour Agents' },
    ...
    // B2B Partnership страница
    'b2b.page_title': { ru: 'Партнерская программа для турагентов - Bunyod-Tour', en: 'Partnership Program for Travel Agents - Bunyod-Tour' },
    'b2b.hero_title': { ru: 'Станьте партнером Bunyod-Tour', en: 'Become a Bunyod-Tour Partner' },
    'b2b.hero_subtitle': { ru: 'Присоединяйтесь к нашей программе B2B-партнерства и получайте эксклюзивные условия для ваших клиентов', en: 'Join our B2B partnership program and get exclusive conditions for your clients' },
    'b2b.benefits_title': { ru: 'Почему стоит работать с нами?', en: 'Why Work With Us?' },
    'b2b.benefit1_title': { ru: 'Выгодные комиссии', en: 'Attractive Commissions' },
    'b2b.benefit1_text': { ru: 'Получайте конкурентные комиссионные за каждое приведенное бронирование', en: 'Earn competitive commissions for every referral booking' },
    'b2b.benefit2_title': { ru: 'Поддержка 24/7', en: '24/7 Support' },
    'b2b.benefit2_text': { ru: 'Персональный менеджер и техническая поддержка в любое время', en: 'Personal manager and technical support anytime' },
    'b2b.benefit3_title': { ru: 'Личный кабинет', en: 'Personal Dashboard' },
    'b2b.benefit3_text': { ru: 'Удобная система отслеживания бронирований и статистики', en: 'Convenient booking and statistics tracking system' },
    'b2b.form_title': { ru: 'Заявка на партнерство', en: 'Partnership Application' },
    'b2b.form_subtitle': { ru: 'Заполните форму, и мы свяжемся с вами в течение 24 часов', en: 'Fill out the form and we\'ll contact you within 24 hours' },
    'b2b.form_fullname': { ru: 'ФИО (полное)', en: 'Full Name' },
    'b2b.form_fullname_placeholder': { ru: 'Иванов Иван Иванович', en: 'John Smith Doe' },
    'b2b.form_citizenship': { ru: 'Гражданство', en: 'Citizenship' },
    'b2b.form_citizenship_placeholder': { ru: 'Например: Таджикистан', en: 'For example: Tajikistan' },
    'b2b.form_address': { ru: 'Адрес', en: 'Address' },
    'b2b.form_address_placeholder': { ru: 'Укажите ваш полный адрес', en: 'Enter your full address' },
    'b2b.form_phone': { ru: 'Телефон', en: 'Phone' },
    'b2b.form_phone_placeholder': { ru: '+992 XX XXX XXXX', en: '+992 XX XXX XXXX' },
    'b2b.form_email': { ru: 'Email', en: 'Email' },
    'b2b.form_email_placeholder': { ru: 'your@email.com', en: 'your@email.com' },
    'b2b.form_id_document': { ru: 'Документ, удостоверяющий личность', en: 'Identity Document' },
    'b2b.form_other_documents': { ru: 'Другие документы (опционально)', en: 'Other Documents (Optional)' },
    'b2b.form_upload_hint': { ru: 'Нажмите для выбора файла или перетащите сюда', en: 'Click to select file or drag here' },
    'b2b.form_upload_formats': { ru: 'Форматы: JPG, PNG, PDF (макс. 10MB)', en: 'Formats: JPG, PNG, PDF (max. 10MB)' },
    'b2b.form_upload_formats_multiple': { ru: 'Можно загрузить несколько файлов (макс. 10MB каждый)', en: 'Multiple files can be uploaded (max. 10MB each)' },
    'b2b.form_agreement1': { ru: 'Согласен с', en: 'I agree to the' },
    'b2b.form_agreement1_link': { ru: 'Договором о партнерстве', en: 'Partnership Agreement' },
    'b2b.form_agreement2': { ru: 'Согласен с', en: 'I agree to the' },
    'b2b.form_agreement2_link': { ru: 'Политикой конфиденциальности', en: 'Privacy Policy' },
    'b2b.form_submit': { ru: 'Отправить заявку', en: 'Submit Application' },
    'b2b.form_submitting': { ru: 'Отправка...', en: 'Submitting...' },
    'b2b.files_selected': { ru: 'Выбрано файлов', en: 'Files selected' },
    ...
    'agent.login_title': { ru: 'Вход для партнеров - Bunyod-Tour', en: 'Partner Login - Bunyod-Tour' },
    'agent.login_heading': { ru: 'Вход для партнеров', en: 'Partner Login' },
    'agent.login_subtitle': { ru: 'Войдите в личный кабинет турагента', en: 'Enter your travel agent account' },
    'agent.email': { ru: 'Email', en: 'Email' },
    'agent.email_placeholder': { ru: 'Введите email', en: 'Enter email' },
    'agent.password': { ru: 'Пароль', en: 'Password' },
    'agent.password_placeholder': { ru: 'Введите пароль', en: 'Enter password' },
    'agent.login_button': { ru: 'Войти', en: 'Log In' },
    'agent.logging_in': { ru: 'Вход...', en: 'Logging in...' },
    'agent.no_account': { ru: 'Еще не партнер?', en: 'Not a partner yet?' },
    'agent.apply_partnership': { ru: 'Подать заявку на партнерство', en: 'Apply for partnership' },
    'agent.login_error': { ru: 'Ошибка при входе', en: 'Login error' },
    'agent.login_error_network': { ru: 'Ошибка сети. Попробуйте позже.', en: 'Network error. Please try again.' },
    'agent.dashboard_title': { ru: 'Личный кабинет партнера - Bunyod-Tour', en: 'Partner Dashboard - Bunyod-Tour' },
    'agent.id_label': { ru: 'ID партнера:', en: 'Partner ID:' },
    'agent.logout': { ru: 'Выйти', en: 'Log Out' },
    'agent.total_bookings': { ru: 'Всего заявок', en: 'Total Bookings' },
    'agent.pending_bookings': { ru: 'Ожидают обработки', en: 'Pending' },
    'agent.approved_bookings': { ru: 'Одобрено', en: 'Approved' },
    'agent.new_booking_title': { ru: 'Новая заявка на тур', en: 'New Tour Booking' },
    'agent.tour_name': { ru: 'Название тура', en: 'Tour Name' },
    'agent.tour_name_placeholder': { ru: 'Например: Тур по Памиру 7 дней', en: 'Example: Pamir Tour 7 days' },
    'agent.tour_start_date': { ru: 'Дата начала тура', en: 'Tour Start Date' },
    'agent.tour_end_date': { ru: 'Дата окончания тура', en: 'Tour End Date' },
    'agent.tourist_count': { ru: 'Количество туристов', en: 'Number of Tourists' },
    'agent.tourist_count_placeholder': { ru: 'Например: 5', en: 'Example: 5' },
    'agent.tourists_list': { ru: 'Список туристов', en: 'Tourists List' },
    'agent.tourists_list_placeholder': { ru: 'Иванов Иван Иванович\nПетров Петр Петрович\nСидоров Сидор Сидорович', en: 'John Smith\nJane Doe\nMike Johnson' },
    'agent.tourists_list_hint': { ru: 'Укажите ФИО каждого туриста с новой строки', en: 'Enter full name of each tourist on a new line' },
    'agent.submit_booking': { ru: 'Отправить заявку', en: 'Submit Booking' },
    'agent.submitting': { ru: 'Отправка...', en: 'Submitting...' },
    'agent.my_bookings': { ru: 'Мои заявки', en: 'My Bookings' },
    'agent.reg_number': { ru: 'Номер регистрации', en: 'Registration Number' },
    'agent.dates': { ru: 'Даты', en: 'Dates' },
    'agent.tourists': { ru: 'Туристов', en: 'Tourists' },
    'agent.status': { ru: 'Статус', en: 'Status' },
    'agent.created_date': { ru: 'Дата создания', en: 'Created Date' },
    'agent.loading': { ru: 'Загрузка...', en: 'Loading...' },
    'agent.load_error': { ru: 'Ошибка загрузки данных', en: 'Error loading data' },
    'agent.no_bookings': { ru: 'У вас пока нет заявок', en: 'You have no bookings yet' },
    'agent.booking_success': { ru: 'Заявка успешно создана!', en: 'Booking successfully created!' },
    'agent.booking_error': { ru: 'Ошибка при создании заявки', en: 'Error creating booking' },
    'agent.booking_error_network': { ru: 'Ошибка сети. Попробуйте позже.', en: 'Network error. Please try again.' },
    
    // Status translations
    'status.pending': { ru: 'Ожидает', en: 'Pending' },
    'status.approved': { ru: 'Одобрено', en: 'Approved' },
    'status.rejected': { ru: 'Отклонено', en: 'Rejected' },
    ...
    'tour.type_personal': { ru: 'Персональный', en: 'Personal' },
    'tour.type_group_personal': { ru: 'Групповой персональный', en: 'Group Personal' },
