...
window.translations = window.translations || {
    ...
    'agent.documents': { ru: 'Документы (лицензия, регистрация, документ удостоверяющий личность)', en: 'Documents (license, registration, identity document)' },
    'agent.documents_hint': { ru: 'Форматы: PDF, JPG, PNG. Максимум 10 файлов', en: 'Formats: PDF, JPG, PNG. Maximum 10 files' },
